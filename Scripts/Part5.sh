...
# Exception to the policy , allow trafic from Server_Net_Interface => Client_Net_Interface
$iptablesPATH -A FORWARD -i $Server_Net_Interface -o $Client_Net_Interface -j ACCEPT

# Exception to the policy , allow trafic from Client_Net_Interface => Server_Net_Interface 
